...
Khi kênh được cấu hình để đồng bộ nhưng [danh sách chương trình trống](../2-epg/2.2-epg-list#danh-sách-trống) thay vì chủ động đồng bộ lịch phát sóng, người dùng có thể chọn nhập lịch phát sóng từ một file Excel.
...
![](/docs/images/lrm/pop-up/import-epg.png)
